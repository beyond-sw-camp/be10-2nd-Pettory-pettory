package com.pettory.userserver.walkingRecord.command.application.service;
...
import com.pettory.userserver.walkingRecord.command.application.dto.WalkingRecordUpdateRequest;
import com.pettory.userserver.walkingRecord.command.domain.aggregate.WalkingRecord;
import com.pettory.userserver.walkingRecord.command.domain.aggregate.WalkingRecordState;
import com.pettory.userserver.walkingRecord.command.domain.repository.WalkingRecordRepository;
import com.pettory.userserver.walkingRecord.command.infrastructure.repository.JpaWalkingRecordRepository;
import com.pettory.userserver.walkingRecord.command.mapper.WalkingRecordMapper;
