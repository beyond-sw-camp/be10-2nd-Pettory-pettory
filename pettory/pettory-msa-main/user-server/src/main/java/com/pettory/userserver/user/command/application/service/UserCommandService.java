...
import com.pettory.userserver.exception.AlreadyRegisterException;
import com.pettory.userserver.exception.AlreadyResignException;
...
import com.pettory.userserver.user.command.application.dto.ChangePasswordRequest;
import com.pettory.userserver.user.command.application.dto.UserDeleteRequest;
...
import com.pettory.userserver.user.command.mapper.UserMapper;
...
//            throw new com.pettory.userserver.exception.MailException("이메일 전송 중 오류가 발생했습니다. 다시 시도해 주세요.");
//        } catch (Exception e) {
//            // 그 외의 예외 처리
