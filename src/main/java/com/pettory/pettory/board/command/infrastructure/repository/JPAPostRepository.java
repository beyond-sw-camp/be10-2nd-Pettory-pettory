...
public interface JPAPostRepository extends JpaRepository<Post, Long> {
    ...
    @Query("SELECT new com.pettory.pettory.board.query.dto.BoardPostDetailDTO(p.postNum, p.postTitle, p.postContent, p.postHits, p.postWriterNum, p.postInsertDatetime) " +
